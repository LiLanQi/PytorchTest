    ...
    def __init__(self, rootdir, result_src, phase, lable_index):
        ...
        for path in path_list:
            ...
            for i in range(5, len(file_list) - 2):
                ...
                max_y = max(y, max_y)
                max_z = max(z, max_z)
                temp_result_list.append(ord(single_temp_atom))
...
if __name__ == '__main__':
    ...
    print('GCNTest7 Finished Training, lr=', args.lr, "batchsize=", args.batchsize)
    PATH = './GCNTest7.pth'
