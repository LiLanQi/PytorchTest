...
if __name__ == '__main__':
    data_list = []
    load_PATH_net = './GCNTest5_net.pth'
    load_PATH_model = './GCNTest5_model.pth'
    data_list = []
    for i in range(1000):
        data_list.append(i)
    ...
    net.load_state_dict(torch.load(load_PATH_net))
    ...
    print('GCNTest5 Finished Training, lr=', args.lr, "batchsize=", args.batchsize)
    PATH1 = './GCNTest5_net.pth'
    PATH2 = './GCNTest5_model.pth'
