...
if __name__ == '__main__':
    ...
    optimizer1 = torch.optim.Adam(net.parameters(), lr=args.lr, weight_decay=args.weight_decay)
    ...
    for epoch in range(100):
        ...
        for i_batch, batch_data in tqdm(enumerate(data_loader)):
            ...
            # print("solute_data.shape=",solute_data.shape) #(4,2076,4)
            # print("solvent_data.shape=", solvent_data.shape)#(4,8940,4)
    ...
    print('GCNTest3 Finished Training, lr=', args.lr, "batchsize=", args.batchsize)
    PATH = './GCNTest3.pth'
