...
from MyFinalGNN3 import MyNewGNN, MyValModel
...
writer = SummaryWriter('MyFinalGNNTest03')
...
def train(net, optimizer, criterion, test_model, train_loader, solute, zero_solvent, one_solvent, two_solvent,
    ...
    PATH1 = "./check_point/MyFinalGNNTest3/" + str(current_epoch) + "/" +str(current_iter)
    ...
    if(current_iter % 20 ==0):
        ...
        torch.save({'state_dict': net.state_dict(), 'optimizer': optimizer.state_dict()},
               "./check_point/MyFinalGNNTest3/" + str(current_epoch) + "/" + str(current_iter) + "-MyFinalGNNTest3_net.pth.tar")
...
if __name__ == '__main__':
    ...
    for current_epoch in range(args.epoch):
        root_path = "./check_point/MyFinalGNNTest3/" + str(current_epoch)
