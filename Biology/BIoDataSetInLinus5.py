        ...
        for path in path_list:
            ...
            for i in range(temp.shape[0]):
                ...
                if ((x < 160) and (y < 70) and (z < 80)):
                    data[0][x][y][z] = max(dict[atom], data[0][x][y][z])
...
if __name__ == '__main__':
    ...
    print('BIoDataSetInLinus5 Finished Training, lr=',args.lr,"batchsize=",args.batchsize)
    PATH = './bio_net5.pth'
