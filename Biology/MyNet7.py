...
class MyNet7(nn.Module):
    def __init__(self):
        ...
        #(B, 1000, 70, 40)
        self.conv1 = nn.Conv2d(1000, 512, 3, stride=1, padding=1)
        self.batchnormalization1 = nn.BatchNorm2d(512)
        self.conv2 = nn.Conv2d(512, 256, 3, stride=1, padding=1)
        self.batchnormalization2 = nn.BatchNorm2d(256)
        ...
        self.batchnormalization4 = nn.BatchNorm2d(64)

        self.pool = nn.MaxPool2d(2, stride=2)
        self.dropout = nn.Dropout(0.5)


        self.fc1 = nn.Linear(64*4*2, 180)
