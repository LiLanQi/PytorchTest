        ...
        for path in path_list:
            ...
            for i in range(temp.shape[0]):
                ...
                if ((x < 160) and (y < 70) and (z < 80)):
                    data[z][x][y] = max(dict[atom], data[z][x][y])
...
if __name__ == '__main__':
    ...
    print('BIoDataSetInLinus Finished Training, lr=',args.lr,"batchsize=",args.batchsize)
    PATH = './bio_net.pth'
