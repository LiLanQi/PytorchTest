...
from MyFinalGCN0 import MyNewGNN, MyValModel
...
parser.add_argument('--checkpoint_PATH', type=str, default="./check_point/MyGCNTest0/1/198-MyGCNTest0_net_in_5.pth.tar")
