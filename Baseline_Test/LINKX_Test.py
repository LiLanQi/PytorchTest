...
def build_model(checkpoint_PATH):
    net = LINKX(args.batchsize*(14226+16020+16860+18411), args.nfeat, hidden_channels=args.nhid,
              out_channels=4*args.batchsize, num_layers=1,
              num_edge_layers=1, num_node_layers=1, dropout=0.5)
    net = net.to(DEVICE)
    ...
    test_model = LINKX(args.batchsize*(11016), args.nfeat, hidden_channels=args.nhid,
...
def train(net, optimizer, criterion, test_model, train_loader, solute, zero_solvent, one_solvent, two_solvent,
    ...
    for i_batch, batch_data in tqdm(enumerate(train_loader)):
        ...
        with torch.set_grad_enabled(True):  #
            ...
            outputs = net(data, edges).squeeze(-1)
