...
from MyAblationGNN4 import MyNewGNN, MyValModel
...
parser.add_argument('--checkpoint_PATH', type=str, default="./check_point/MyAbalationGNNTest4/1/231-MyAbalationGNNTest4_net_in_5.pth.tar")
