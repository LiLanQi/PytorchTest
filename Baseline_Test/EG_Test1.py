...
writer = SummaryWriter('LINKXTest0')
...
def get_solute_adj(dict_solute):
    ...
    # print("torch.tensor(solute_adj).T.shape=", torch.tensor(solute_adj).T.shape)
...
def get_solvent_adj(solvent, dict_solvent):
    ...
    # print("torch.tensor(solvent_adj).T.shape=", torch.tensor(solvent_adj).T.shape)
    return torch.tensor(solvent_adj).T

def get_single_adj(dict_solute, solvent, dict_solvent):
    solution_adj = []
    solute_bonds = 'S1-O3', 'S1-O4', 'S1-F1', 'S1-O1', 'O1-C3', 'C3-C4', 'C4-H3', 'C4-C5', 'C5-H4', 'C5-C6', 'C6-C1', 'C1-H1', 'C1-C2', 'C2-H2', 'C2-C3', 'C6-C19', 'C19-C14', 'C14-C13', 'C13-H9', 'C13-C18', 'C18-H12', 'C18-C17', 'C17-C16', 'C16-H11', 'C16-C15', 'C15-H10', 'C15-C14', 'C17-O2', 'O2-S2', 'S2-O5', 'S2-O6', 'S2-F2', 'C19-H13', 'C19-C10', 'C10-C11', 'C11-H7', 'C11-C12', 'C12-H8', 'C12-C7', 'C7-C8', 'C8-H5', 'C8-C9', 'C9-H6', 'C9-C10', 'C7-O25', 'O25-S8', 'S8-O26', 'S8-O27', 'S8-O22', 'O22-C64', 'C64-C69', 'C69-H47', 'C69-C68', 'C68-H46', 'C68-C67', 'C67-C66', 'C66-H45', 'C66-C65', 'C65-H44', 'C65-C64', 'C67-C76', 'C76-H52', 'C76-C71', 'C71-C70', 'C70-H48', 'C70-C75', 'C75-H51', 'C75-C74', 'C74-C73', 'C73-H50', 'C73-C72', 'C72-H49', 'C72-C71', 'C74-O24', 'O24-S9', 'S9-O29', 'S9-O30', 'S9-O28', 'O28-C26', 'C26-C27', 'C27-H18', 'C27-C28', 'C28-H19', 'C28-C29', 'C29-C30', 'C30-H20', 'C30-C31', 'C31-H21', 'C31-C26', 'C29-C38', 'C38-H26', 'C38-C25', 'C25-C20', 'C20-H14', 'C20-C21', 'C21-H15', 'C21-C22', 'C22-C23', 'C23-H16', 'C23-C24', 'C24-H17', 'C24-C25', 'C22-O7', 'O7-S3', 'S3-O9', 'S3-O10', 'S3-F3', 'C38-C33', 'C33-C32', 'C32-H22', 'C32-C37', 'C37-H25', 'C37-C36', 'C36-C35', 'C35-H24', 'C35-C34', 'C34-H23', 'C34-C33', 'C36-O8', 'O8-S4', 'S4-O11', 'S4-O12', 'S4-F4', 'C76-C63', 'C63-C62', 'C62-H43', 'C62-C61', 'C61-H42', 'C61-C60', 'C60-C59', 'C59-H41', 'C59-C58', 'C58-H40', 'C58-C63', 'C60-O23', 'O23-S7', 'S7-O20', 'S7-O21', 'S7-O17', 'O17-C55', 'C55-C56', 'C56-H38', 'C56-C51', 'C51-H35', 'C51-C52', 'C52-C53', 'C53-H36', 'C53-C54', 'C54-C55', 'C54-H37', 'C52-C57', 'C57-H39', 'C57-C48', 'C48-C47', 'C47-H32', 'C47-C46', 'C46-H31', 'C46-C45', 'C45-C50', 'C50-H34', 'C50-C49', 'C49-H33', 'C49-C48', 'C45-O13', 'O13-S5', 'S5-O14', 'S5-O15', 'S5-F5', 'C57-C44', 'C44-C43', 'C43-H30', 'C43-C42', 'C42-H29', 'C42-C41', 'C41-C40', 'C40-H28', 'C40-C39', 'C39-H27', 'C39-C44', 'C41-O16', 'O16-S6', 'S6-O18', 'S6-O19', 'S6-F6'
    if (solvent == "ACE"):
        atom_nums = 6
        atom_g = 1490
        bonds = 'C1-H1', 'C1-H2', 'C1-H3', 'C1-C2', 'C2-N1'
        ...
        bonds = 'C1-H1', 'C1-O1', 'C1-N1', 'N1-C2', 'C2-H2', 'C2-H3', 'C2-H4', 'N1-C3', 'C3-H5', 'C3-H6', 'C3-H7'
        num_node = 16020
    for connect_atom in solute_bonds:
        left_atom = connect_atom.split("-")[0]
        right_atom = connect_atom.split("-")[-1]
        for i in range(12):
            left_atom_value = dict_solute[left_atom] + 173 * i
            right_atom_value = dict_solute[right_atom] + 173 * i
            solution_adj.append((left_atom_value, right_atom_value))
            solution_adj.append((right_atom_value, left_atom_value))
    for connect_atom in bonds:
        left_atom = connect_atom.split("-")[0]
        right_atom = connect_atom.split("-")[-1]
    ...
    solution_adj = torch.tensor(solution_adj).T
    init_solution_adj = solution_adj
    for i in range(args.batchsize):
        if (i == 0):
            continue
        temp = torch.zeros_like(init_solution_adj)
        temp[:,:] = num_node*i
        temp_solution_adj = torch.add(init_solution_adj, temp)
        solution_adj = torch.cat((solution_adj, temp_solution_adj), 1)
    # print("solution_adj.shape=", solution_adj.shape)
    return solution_adj



def get_all_adj(test_index, solution0_adj, solution1_adj, solution2_adj, solution3_adj, solution4_adj):
    num_node_ACE = 11016*args.batchsize
    num_node_NMF = 14226 * args.batchsize
    num_node_DMF = 16020 * args.batchsize
    num_node_water = 16860 * args.batchsize
    num_node_meth = 18411 * args.batchsize
    dict_index_to_solvent = {0: "ACE", 1: "NMF", 2: "DMF", 3: "wat", 4: "meth"}

    if(test_index == 0):
        solution_adj = solution1_adj
        # temp1 = num_node_NMF
        temp2 = torch.zeros_like(solution2_adj)
        temp2[:, :] = num_node_NMF
        temp2 = torch.add(solution2_adj,temp2)
        solution_adj = torch.cat((solution_adj, temp2), 1)
        temp3 = torch.zeros_like(solution3_adj)
        temp3[:, :] = num_node_NMF + num_node_DMF
        temp3 = torch.add(solution3_adj, temp3)
        solution_adj = torch.cat((solution_adj, temp3), 1)
        temp4 = torch.zeros_like(solution4_adj)
        temp4[:, :] = num_node_NMF + num_node_DMF + num_node_water
        temp4 = torch.add(solution4_adj, temp4)
        solution_adj = torch.cat((solution_adj, temp4), 1)
    # print("solution0_adj.shape=", solution0_adj.shape)
    # print("solution1_adj.shape=", solution1_adj.shape)
    # print("solution2_adj.shape=", solution2_adj.shape)
    # print("solution3_adj.shape=", solution3_adj.shape)
    # print("solution4_adj.shape=", solution4_adj.shape)
    # print("solution_adj.shape=", solution_adj.shape)
    return solution_adj
...
def val(net, val_loader, solute, zero_solvent, one_solvent, two_solvent,three_solvent):
    ...
    for i_batch, batch_data in tqdm(enumerate(val_loader)):
        labels, solute_data_zero, solute_data_one, solute_data_two, solute_data_three, solvent_data_zero, solvent_data_one, solvent_data_two, solvent_data_three = para_to_device(batch_data)
...
def val_another_solvent(test_model, test_loader, solute, solvent_test, PATH1, bestSUM_solvent_in_5, bestSUM_solvent_in_10, best_PATH5,
    ...
    if (SUMtest10 > bestSUM_solvent_in_10):
        ...
        best_PATH10 = PATH1 + "-LINKXTest0_net_in_10.pth.tar"
    if (SUMtest5 > bestSUM_solvent_in_5):
        bestSUM_solvent_in_5 = SUMtest5
        best_PATH5 = PATH1 + "-LINKXTest0_net_in_5.pth.tar"
    ...
    print("tatol", (SUMtest5 * 100) / (len(test_loader) * args.batchsize), "% test_solvent in 5%;", "tatol",
          (SUMtest10 * 100) / (len(test_loader) * args.batchsize), "% test_solvent in 10%", ";current_iter=", current_iter)
    return best_PATH5, best_PATH10, bestSUM_solvent_in_5, bestSUM_solvent_in_10

def build_model(checkpoint_PATH):
    net = Net(hidden_channels=236, num_layers=4, num_heads=4,
            num_bases=4)
    net = net.to(DEVICE)
    ...
    schedular_r = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', factor=0.1, patience=args.patience, verbose=True, eps=1e-8)
    # schedular_r = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, 10, eta_min=0, last_epoch=-1)
    schedular = GradualWarmupScheduler(optimizer, multiplier=1000, total_epoch=args.warmup_step, after_scheduler=schedular_r)
...
def get_graph_pool_batch(len_solute, len0, len1, len2, len3):
    init_batch = torch.LongTensor([0] * (len_solute + len0))
    for i in range(4*args.batchsize):
        if (i == 0):
            continue
        if(i < args.batchsize):
            batch = torch.LongTensor([i] *  (len_solute + len0))
        elif ((i >= args.batchsize) and (i < 2*args.batchsize)):
            batch = torch.LongTensor([i] *  (len_solute + len1))
        elif ((i >= 2*args.batchsize) and (i < 3*args.batchsize)):
            batch = torch.LongTensor([i] *  (len_solute + len2))
        else:
            batch = torch.LongTensor([i] * (len_solute + len3))
...
def train(net, optimizer, criterion, test_model, train_loader, solute, zero_solvent, one_solvent, two_solvent,
          ...
          bestSUM_solvent_in_10, current_iter, current_epoch, batch_num, schedular, edges):
    loss_list = []
    # tf_flag = 0
    net.train()
    total_loss = 0
    for i_batch, batch_data in tqdm(enumerate(train_loader)):
        ...
        data_batch = get_graph_pool_batch(len_solute, len_solvent_zero, len_solvent_one, len_solvent_two,
                                          len_solvent_three).to(DEVICE)
        solution_zero = torch.cat((solute_data_zero, solvent_data_zero), 1).reshape(-1, 9)
        solution_one = torch.cat((solute_data_one, solvent_data_one), 1).reshape(-1, 9)
        solution_two = torch.cat((solute_data_two, solvent_data_two), 1).reshape(-1, 9)
        solution_three = torch.cat((solute_data_three, solvent_data_three), 1).reshape(-1, 9)
        temp1 = torch.cat((solution_zero, solution_one), 0)
        temp2 = torch.cat((solution_two, solution_three), 0)
        data = torch.cat((temp1, temp2))
        edges = edges.to(DEVICE)
        optimizer.zero_grad()
        with torch.set_grad_enabled(True):  #
            print("data.shape= ", data.shape)
            print("edges.shape= ", edges.shape)
            outputs = net(data[:7].int(), edges, data_batch).squeeze(-1)
    ...
    PATH1 = "./check_point/LINKXTest0/" + str(current_epoch) + "/" +str(current_iter)
    ...
    if(current_iter % 20 ==0):
        ...
        torch.save({'state_dict': net.state_dict(), 'optimizer': optimizer.state_dict()},
               "./check_point/LINKXTest0/" + str(current_epoch) + "/" + str(current_iter) + "-LINKXTest0_net.pth.tar")
    zero_accuracy, one_accuracy, two_accuracy, three_accuracy = val(net, val_loader, solute, zero_solvent, one_solvent, two_solvent,three_solvent)
...
def split_train_and_test_solvent(test_index):
    ...
    solution0_adj = get_single_adj(dict_solute, "ACE", dict_solvent_ACE)
    solution1_adj = get_single_adj(dict_solute, "NMF", dict_solvent_NMF)
    solution2_adj = get_single_adj(dict_solute, "DMF", dict_solvent_DMF)
    solution3_adj = get_single_adj(dict_solute, "wat", dict_solvent_wat)
    solution4_adj = get_single_adj(dict_solute, "meth", dict_solvent_meth)
    edges = get_all_adj(0, solution0_adj, solution1_adj, solution2_adj, solution3_adj, solution4_adj)
    ...
    return solute, zero_solvent, one_solvent, two_solvent, three_solvent, solvent_test, edges
...
if __name__ == '__main__':
    ...
    solute, zero_solvent, one_solvent, two_solvent, three_solvent, solvent_test, edges = split_train_and_test_solvent(
        args.test_index)
    ...
    for current_epoch in range(args.epoch):
        root_path = "./check_point/LINKXTest0/" + str(current_epoch)
        ...
        for current_iter in range(batch_num):
            ...
            best_PATH5, best_PATH10, bestSUM_solvent_in_5, bestSUM_solvent_in_10 = TRAIN(net, optimizer, criterion,
                                                                                         ...
                                                                                         solute, zero_solvent, one_solvent,
                                                                                         ...
                                                                                         current_iter, current_epoch, batch_num, schedular, edges)