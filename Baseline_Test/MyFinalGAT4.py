...
from torch_geometric.nn import GCNConv, SAGEConv, Set2Set, GINConv, GATv2Conv
...
class MyNewGNN(nn.Module):
    ...
    def __init__(self, nfeat, nhid, nclass, dropout, DEVICE, batch_size):
        ...
        self.solute_conv1 = GATv2Conv(nclass, nclass)
        self.solute_conv2 = GATv2Conv(nclass, nclass)

        self.solvent_conv1 = GATv2Conv(nclass, nclass)
        self.solvent_conv2 = GATv2Conv(nclass, nclass)
