...
from MyFinalGNN1 import MyNewGNN, MyValModel
...
parser.add_argument('--checkpoint_PATH', type=str, default="./check_point/MyFinalGNNTest1/1/17-MyFinalGNNTest1_net_in_5.pth.tar")
