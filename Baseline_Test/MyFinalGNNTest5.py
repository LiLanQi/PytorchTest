...
from MyFinalGNN5 import MyNewGNN, MyValModel
...
writer = SummaryWriter('MyFinalGNNTest5')
...
def val(net, val_loader, solute, zero_solvent, one_solvent, two_solvent,three_solvent, four_solvent):
    ...
    for i_batch, batch_data in tqdm(enumerate(val_loader)):
        labels, solute_data_zero, solute_data_one, solute_data_two, solute_data_three,solute_data_four, solvent_data_zero, solvent_data_one, solvent_data_two, solvent_data_three, solvent_data_four = para_to_device(batch_data)
    ...
    for i_batch, batch_data in tqdm(enumerate(train_loader)):
        ...
        with torch.set_grad_enabled(True):  #
            outputs = net(solute_data_zero, solvent_data_zero, solute, zero_solvent,
                          ...
                          solute_data_two, solvent_data_two, two_solvent,
                          solute_data_three, solvent_data_three, three_solvent,
                          solute_data_four, solvent_data_four, solvent_test).squeeze(-1)
    ...
    for current_epoch in range(args.epoch):
        ...
        for current_iter in range(batch_num):
            ...
            best_PATH5, best_PATH10, bestSUM_solvent_in_5, bestSUM_solvent_in_10 = TRAIN(net, optimizer, criterion,
                                                                                         ...
                                                                                         current_iter, current_epoch, batch_num, schedular)