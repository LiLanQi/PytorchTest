...
from MyFinalGCN2 import MyNewGNN, MyValModel
...
parser.add_argument('--checkpoint_PATH', type=str, default="./check_point/MyGCNTest02/2/4-MyGCNTest02_net_in_5.pth.tar")
