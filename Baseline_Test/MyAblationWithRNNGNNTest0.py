...
from MyAblationWithRNNGNN0 import MyNewGNN, MyValModel
...
parser.add_argument('--root_path', type=str, default="./check_point/MyAbalationWithRNNGNNTest0/")
parser.add_argument('--check_point_name', type=str, default="-MyAbalationWithRNNGNNTest0_net.pth.tar")
parser.add_argument('--check_point_name_five', type=str, default="-MyAbalationWithRNNGNNTest0_net_in_10.pth.tar")
parser.add_argument('--check_point_name_ten', type=str, default="-MyAbalationWithRNNGNNTest0_net_in_10.pth.tar")
...
writer = SummaryWriter('MyAbalationWithRNNGNNTest0')
