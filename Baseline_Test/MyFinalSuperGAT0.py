...
from torch_geometric.nn import GCNConv, SAGEConv, Set2Set, GINConv, GATv2Conv, GATConv,SuperGATConv
...
class MyNewGNN(nn.Module):
    ...
    def __init__(self, nfeat, nhid, nclass, dropout, DEVICE, batch_size):
        ...
        self.solute_conv1 = SuperGATConv(nclass, nclass)
        self.solute_conv2 = SuperGATConv(nclass, nclass)

        self.solvent_conv1 = SuperGATConv(nclass, nclass)
        self.solvent_conv2 = SuperGATConv(nclass, nclass)
