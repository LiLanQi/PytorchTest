...
from MyAblationWithAtomGNN0 import MyNewGNN, MyValModel
...
parser.add_argument('--root_path', type=str, default="./check_point/MyAbalationWithAtomGNNTest0/")
parser.add_argument('--check_point_name', type=str, default="-MyAbalationWithAtomGNNTest0_net.pth.tar")
parser.add_argument('--check_point_name_five', type=str, default="-MyAbalationWithAtomGNNTest0_net_in_10.pth.tar")
parser.add_argument('--check_point_name_ten', type=str, default="-MyAbalationWithAtomGNNTest0_net_in_10.pth.tar")
...
writer = SummaryWriter('MyAbalationWithAtomGNNTest0')
