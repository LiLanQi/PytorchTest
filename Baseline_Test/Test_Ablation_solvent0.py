...
from MyAblationGNN0 import MyNewGNN, MyValModel
...
parser.add_argument('--nfeat', type=int, default=3)
...
parser.add_argument('--checkpoint_PATH', type=str, default="./check_point/MyAbalationGNNTest0/1/155-MyAbalationGNNTest0_net_in_5.pth.tar")
...
def val_another_solvent(test_model, test_loader, solute, solvent_test):
    test_model.eval()
    SUMtest1 = 0
    SUMtest2 = 0
    SUMtest3 = 0
    ...
    return SUMtest5, SUMtest10, len(test_loader) * args.batchsize
...
def LOAD(know_solvent_test_index, unknow_solvent_test_index, zero_solvent, one_solvent, two_solvent, three_solvent,
    ...
    return zero_solvent_test_loader, one_solvent_test_loader, two_solvent_test_loader, three_solvent_test_loader, unknow_solvent_test_loader
...
if __name__ == '__main__':
    ...
    for current_iter in range(batch_num):
        ...
        SUM_test5, SUM_test10, SUM_unknow_test = val_another_solvent(test_model, unknow_solvent_test_loader, solute, solvent_test)
