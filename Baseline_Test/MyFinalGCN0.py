...
class MyNewGNN(nn.Module):
    ...
    def __init__(self, nfeat, nhid, nclass, dropout, DEVICE, batch_size):
        ...
        self.solute_conv1 = GCNConv(nclass, nclass)
        self.solute_conv2 = GCNConv(nclass, nclass)

        self.solvent_conv1 = GCNConv(nclass, nclass)
        self.solvent_conv2 = GCNConv(nclass, nclass)
