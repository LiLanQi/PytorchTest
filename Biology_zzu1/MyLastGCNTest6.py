...
import argparse
import os
from MyLastGCNTestmeth6 import MyValModel
from MyLastGCN6 import MyNewGCN
...
writer = SummaryWriter('MyLastGCNTest6')
...
def val(val_model, val_loader, solute_adj, solvent_adj_meth, PATH1, bestSUMmeth5, bestSUMmeth10, best_PATH5, best_PATH10):
    ...
    print("SUMmeth6 = ", SUMmeth6, "SUMmeth7 = ", SUMmeth7, "SUMmeth8 = ", SUMmeth8, "SUMmeth9 = ", SUMmeth9,
          "SUMmeth10 = ", SUMmeth10)
    print("tatol", (SUMmeth5*100)/len(val_loader), "% meth in 5%", "tatol", (SUMmeth10*100)/len(val_loader), "% meth in 10%")
...
def train(train_loader, solute_adj, solvent_adj_ACE, solvent_adj_NMF, solvent_adj_wat, val_loader, solvent_adj_meth):
    ...
    for epoch in range(args.epoch):
        ...
        PATH1 = "./check_point/" + str(epoch) + 'MyLastGCNTest6_net.pth'
    ...
    print('MyLastGCNTest6 Finished Training, lr=', args.lr, "batchsize=", args.batchsize)
...
if __name__ == '__main__':
    ...
    train_loader = load_data(args.data_src_ACE, args.batchsize, "train", args.data_src_NMF, data_list, args.data_src_wat)
    val_loader = load_val_data(args.batchsize, "val",data_list, args.data_src_meth)
    net = MyNewGCN(nfeat=9, nhid=64, nclass=128, dropout=0, DEVICE=DEVICE)
    net = net.to(DEVICE)
