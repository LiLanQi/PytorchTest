...
class trainset(Dataset):
    def __init__(self, rootdir_ACE, result_src_ACE, phase, rootdir_NMF, result_src_NMF, lable_index, rootdir_wat, rootdir_meth):
        ...
        for path in path_list_meth:
            ...
            solute_list_meth.append(solute_data)  # 存入每个wat文件的溶质图
            solvent_list_meth.append(solvent_data)  # 存入每个wat文件的溶剂图
        for i in range(len(lable_index)):
...
def load_train(root_path_ACE, batch_size, result_src_ACE, phase,root_path_NMF,result_src_NMF, label_index, root_path_wat, root_path_meth):
    data = trainset(root_path_ACE, result_src_ACE, phase, root_path_NMF, result_src_NMF, label_index, root_path_wat, root_path_meth)
    print("data=", data)
...
if __name__ == '__main__':
    ...
    solvent_adj_wat = get_solvent_adj("ACE", 14784)
    ...
    PATH1 = './model/MynewGCNTest1_net.pth'
    ...
    print("共有", SUMmeth5, "个时刻meth数据误差在5%以内")
