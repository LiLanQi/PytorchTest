...
if __name__ == '__main__':
    ...
    for i in range(2000):
        data_list.append(i)
    train_lable_index, lable_index = train_test_split(data_list, train_size=0.6, random_state=42)
    ...
    for epoch in range(1):
        vali_loss1 = train(model, epoch, train_loader_ACE, "ACE", val_loader_ACE, criterion)
        vali_loss2 = train(model, epoch, train_loader_NMF, "NMF", val_loader_NMF, criterion)
