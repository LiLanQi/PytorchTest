...
import argparse
import os
from MyLastGCNTestmeth1 import MyValModel
from MyLastGCN5 import MyNewGCN
...
writer = SummaryWriter('MyLastGCNTest5')
...
def val(val_model, val_loader, solute_adj, solvent_adj_meth, PATH1, bestSUMmeth5, bestSUMmeth10, best_PATH5, best_PATH10):
    ...
    print("SUMmeth6 = ", SUMmeth6, "SUMmeth7 = ", SUMmeth7, "SUMmeth8 = ", SUMmeth8, "SUMmeth9 = ", SUMmeth9,
          "SUMmeth10 = ", SUMmeth10)
    print("tatol", (SUMmeth5 * 100) / len(val_loader), "% meth in 5%", "tatol", (SUMmeth10 * 100) / len(val_loader),
          "% meth in 10%")
...
def train(train_loader, solute_adj, solvent_adj_ACE, solvent_adj_NMF, solvent_adj_wat, val_loader, solvent_adj_meth):
    ...
    for epoch in range(args.epoch):
        ...
        PATH1 = "./check_point/" + str(epoch) + 'MyLastGCNTest5_net.pth'
        ...
        best_PATH5, best_PATH10, bestSUMmeth5, bestSUMmeth10 = val(val_model, val_loader, solute_adj, solvent_adj_meth,
