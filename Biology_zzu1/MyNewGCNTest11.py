...
parser.add_argument('--result_src_Water', type=str, default='../data/newWater/water-LJ.xvg')
parser.add_argument('--data_src_Water', type=str, default='../data/newWater/WAT_pdb')
