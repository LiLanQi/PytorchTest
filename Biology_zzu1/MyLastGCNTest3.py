...
from MyLastGCN3 import MyNewGCN
...
writer = SummaryWriter('MyLastGCNTest3')
...
class trainset(Dataset):
    ...
    def __init__(self, rootdir_ACE, result_src_ACE, phase, rootdir_NMF, result_src_NMF, lable_index, rootdir_meth,
                 solute_addtional_feature, ACE_atom_to_feature, NMF_atom_to_feature, meth_atom_to_feature):
...
def load_data(root_path_ACE, batch_size, result_src_ACE, phase, root_path_NMF, result_src_NMF, label_index,
               root_path_meth, solute_addtional_feature, ACE_atom_to_feature, NMF_atom_to_feature,
               meth_atom_to_feature):
    data = trainset(root_path_ACE, result_src_ACE, phase, root_path_NMF, result_src_NMF, label_index, root_path_meth,
                    solute_addtional_feature, ACE_atom_to_feature, NMF_atom_to_feature, meth_atom_to_feature)
    print("data=", data)
...
def test(test_loader, test_lable_index, solute_adj, solvent_adj_ACE, solvent_adj_NMF):
    SUMACE1 = 0
    SUMACE2 = 0
    SUMACE3 = 0
    SUMACE4 = 0
    ...
    print("SUMmeth1 = ", SUMmeth1, "SUMmeth2 = ", SUMmeth2, "SUMmeth3 = ", SUMmeth3, "SUMmeth4 = ", SUMmeth4,
          "SUMmeth5 = ", SUMmeth5)
    print("total ", (SUMACE5*100//len(test_lable_index)), "% ACE in 5%;", "total ", (SUMNMF5*100//len(test_lable_index)), "% NMF in 5%;", "total ", (SUMmeth5*100//len(test_lable_index)), "% meth in 5%")

def train(train_loader, solute_adj, solvent_adj_ACE, solvent_adj_NMF):
    net.train()
    ...
    for epoch in range(args.epoch):
        ...
        PATH1 = "./check_point/" + str(epoch) + 'MyLastGCNTest3_net.pth'
        torch.save(net.state_dict(), PATH1)
    print("loss_list = ", loss_list)
    print('MyLastGCNTest3 Finished Training, lr=', args.lr, "batchsize=", args.batchsize)
...
if __name__ == '__main__':
    ...
    train_loader = load_data(args.data_src_ACE, args.batchsize, args.result_src_ACE, "train", args.data_src_NMF,
                              args.result_src_NMF, train_lable_index, args.data_src_meth, solute_addtional_feature,
    ...
    net = net.to(DEVICE)
    train(train_loader, solute_adj, solvent_adj_ACE, solvent_adj_NMF)

    # test
    net.eval()
    test_loader = load_data(args.data_src_ACE, args.batchsize, args.result_src_ACE, "test", args.data_src_NMF,
                             args.result_src_NMF, test_lable_index, args.data_src_meth, solute_addtional_feature,
                             ACE_atom_to_feature, NMF_atom_to_feature, meth_atom_to_feature)
    test(test_loader, test_lable_index, solute_adj, solvent_adj_ACE, solvent_adj_NMF)
