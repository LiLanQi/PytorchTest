...
class trainset(Dataset):
    ...
    def __init__(self, rootdir_ACE, phase, rootdir_NMF,  lable_index, rootdir_wat, rootdir_meth):
        ...
        solute_speed_list_ACE[0] = torch.zeros(self.solute_list_ACE[0].shape[0])
        solvent_speed_list_ACE[0] = torch.zeros(self.solvent_list_ACE[0].shape[0])
        ...
        np.save('./solute_speed_list_ACE.npy', solute_speed_list_ACE)
        np.save('./solvent_speed_list_ACE.npy', solvent_speed_list_ACE)
        ...
        solute_speed_list_NMF[0] = torch.zeros(self.solute_list_NMF[0].shape[0])
        solvent_speed_list_NMF[0] = torch.zeros(self.solvent_list_NMF[0].shape[0])
        for i in range(100000):
            if (i != 0):
        ...
        np.save('./solute_speed_list_NMF.npy', solute_speed_list_NMF)
        np.save('./solvent_speed_list_NMF.npy', solvent_speed_list_NMF)
        ...
        solute_speed_list_wat[0] = torch.zeros(self.solute_list_wat[0].shape[0])
        solvent_speed_list_wat[0] = torch.zeros(self.solvent_list_wat[0].shape[0])
        for i in range(100000):
            if (i != 0):
        ...
        np.save('./solute_speed_list_wat.npy', solute_speed_list_wat)
        np.save('./solvent_speed_list_wat.npy', solvent_speed_list_wat)
        ...
        solute_speed_list_meth[0] = torch.zeros(self.solute_list_meth[0].shape[0])
        solvent_speed_list_meth[0] = torch.zeros(self.solvent_list_meth[0].shape[0])
        for i in range(100000):
            if (i != 0):
        ...
        np.save('./solute_speed_list_meth.npy', solute_speed_list_meth)
        np.save('./solvent_speed_list_meth.npy', solvent_speed_list_meth)
