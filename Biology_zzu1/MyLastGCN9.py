...
class MyNewGCN(nn.Module):
    ...
    def forward(self, solute_ACE, solvent_ACE, solute_adj, solvent_adj_ACE, solute_NMF, solvent_NMF, solvent_adj_NMF, solute_wat, solvent_wat, solvent_adj_wat):
        ...
        solute_ACE = gdp(solute_ACE, solute_batch)
        solute_NMF = gdp(solute_NMF, solute_batch)
        solute_wat = gdp(solute_wat, solute_batch)
        solvent_ACE = gdp(solvent_ACE, solvent_ACE_batch)
        solvent_NMF = gdp(solvent_NMF, solvent_NMF_batch)
        solvent_wat = gdp(solvent_wat, solvent_wat_batch)
