...
import argparse
import os
from MyLastGCNTestmeth11 import MyValModel
from MyLastGCN11 import MyNewGCN
...
writer = SummaryWriter('MyLastGCNTest11')
...
def test(test_model, test_loader, solute_adj, solvent_adj_meth, PATH1, bestSUMmeth5, bestSUMmeth10, best_PATH5, best_PATH10, current_epoch, ACE_accuracy, NMF_accuracy, wat_accuracy):
    ...
    writer.add_scalars('Accuracy ',
                       {"ACE_acc": ACE_accuracy, "NMF_acc": NMF_accuracy, "wat_acc": wat_accuracy, "meth_acc": meth_accuracy},
                       current_epoch)
...
def build_model():
    ...
    criterion = torch.nn.MSELoss() #从MAE换为MSE
...
def train(net, optimizer, criterion, test_model,train_loader, solute_adj, solvent_adj_ACE, solvent_adj_NMF, solvent_adj_wat, val_loader, solvent_adj_meth, test_loader,best_PATH5, best_PATH10, bestSUMmeth5, bestSUMmeth10, current_epoch):
    ...
    for epoch in range(args.epoch):
        ...
        PATH1 = "./check_point/" + str(epoch+current_epoch) + 'MyLastGCNTest11_net.pth'
        torch.save(net.state_dict(), PATH1)

        ACE_accuracy, NMF_accuracy, wat_accuracy, DMF_accuracy = val(net, val_loader, solute_adj, solvent_adj_ACE, solvent_adj_NMF, solvent_adj_wat, epoch+current_epoch)
    ...
    print('MyLastGCNTest11 Finished Training, lr=', args.lr, "batchsize=", args.batchsize)
    return best_PATH5, best_PATH10, bestSUMmeth5, bestSUMmeth10
